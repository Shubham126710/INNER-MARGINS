...
export default function BelieveSign({ className = '' }: { className?: string }) {
  return (
    <div className={`relative flex items-center justify-center w-full max-w-[320px] mx-auto group ${className}`}>
      ...
      {/* The Paper */}
      <div 
        className="bg-[#fad346] w-full aspect-[5/3] relative shadow-[2px_3px_5px_rgba(0,0,0,0.15)] transform -rotate-2 hover:-rotate-1 hover:scale-[1.02] transition-all duration-300 flex items-center justify-center"
      >
        
        {/* The Text */}
        <h2 className="font-marker text-[#19407a] text-5xl md:text-6xl tracking-wider opacity-90 select-none pb-2 pr-1">
          BELIEVE
        </h2>
